...
public class PointTestDistanceSQWithOnePoint {
    @Parameters()
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {new Point(2, 2), new Point(2, 4),
                        4d, new Point(2, 2), new Point(2, 4)},

                {new Point(0, 0), new Point(1, 2),
                        5d, new Point(0, 0), new Point(1, 2),},

                {new Point(3, 4), new Point(0, 0),
                        25d, new Point(3, 4), new Point(0, 0),},

                {new Point(-2, -2), new Point(2, 2),
                        32d, new Point(-2, -2), new Point(2, 2),},
    ...
    public PointTestDistanceSQWithOnePoint(Point a, Point b, double ans, Point ansA, Point ansB) {
        this.a = a;
        this.b = b;
        this.ans = ans;
        this.ansA = ansA;
